...
- **🎟️ PLAYTEST BUILD READY — build\illwill.exe (rebuilt 8:49pm).**
  Your three fixes: (1) TITLE SCREEN — hatted cast, big PLAY -> seat
  setup -> the full night; SETTINGS + MINIGAMES below; swap the art
  anytime at assets/ui/title_bg.png. (2) Moonwalking fixed — echo/tilt/
  greed had a 180-degree model offset; models now face where they walk
  (verified in live exhibition shots). (3) Model/color audit: canonical
  everywhere on this build (RED=axe guy, BLUE=knight, GOLD=wizard,
  MINT=rogue in every game I probed + all screenshots); the one real
  scramble was Understudy standalone fallbacks (fixed). If RED goes
  wizard again tonight, TELL ME WHICH GAME. Bonus catch: the lobby ILL
  WILL banner was leaking into exhibitions -- hidden.
# ALEX MEMORY â€” running log of things worth your review
...
- **â˜€ï¸ MORNING MENU â€” the overnight run is COMPLETE. Start here.**
  1. **Double-click `build\illwill.exe`** â€” the whole game, packed from
  ...
  2. **Playtest priorities**: a full night (the Reading now opens with
     NEMESIS when earned â€” final soak produced "MINT, NEMESIS OF BLUE â€”
     came for them in 3 different games tonight"); THE SÃ‰ANCE and THE
     UNDERSTUDY at the theater (selector, "Â· at the theater Â·" tags â€”
     is the SÃ©ance chant-tap load right with a pad in hand?); Par's new
     KILLCAM ("BLUE'S THE CRUSHER â€” SIGNED WORK" replay at the
  ...
  4. **One doc worth your read**: the Par v4 EMBODIED GOLF spec
     ...
     â€” 5 open questions, each with my recommended default; say "go"
  ...
  5. Small watch-items: monument lawn now shows the 8 newest stones
     ...
     use your eye on the grounds; SÃ©ance/Understudy card verbs came
     from their hint bars â€” correct me if they read wrong in play.

- **ðŸŒ™ OVERNIGHT RUN â€” progress ledger (updating as the night goes).**
  ...
  - **ILL WILL is real**: window title, lobby title card, exe metadata.
    ...
    dir â€” a Migrate autoload copies estate history/seats/cosmetics over;
  ...
  - **How-to-Play cards**: every selector game now opens a card â€” goal,
  ...
  - **THE EXECUTOR is on the grounds** (Meshy butler by the gates) and
    SPEAKS â€” Saki register throughout: ledger-aware lobby greeting
  ...
  - **THE THEATER stands** on the right flank (red curtains, gold trim).
    THE SÃ‰ANCE (research pick #1: co-op spirit-board with a paid
    saboteur, Executor as medium) is being built by a Fable agent NOW.
    Research doc: docs/design/06-social-deduction-research.md â€” worth
    your read; it argues 4-player bluff-and-vote needed re-engineering
    and pitched three formats (SÃ©ance / Understudy / Masked Ball).
  - **Kill attribution fleet: ALL FOUR MERGED.** Every game reports
    ...
    <name> â€” hunted them down N times tonight**. (Director's ruling:
    Swap Meet's position-swaps are theft, not kills â€” filtered.)
  - **Style unification: echo/tilt/dead_weight now live at the same
    party** â€” echo's neon ghosts over a warm wooden well (stunning:
    ...
    hazard trim. Par got scoreboard badges + a proper "CHAOS â€” EVERYONE
    AT ONCE" banner.
  - **Music scaffold ready**: drop .ogg files at assets/music/
    (lobby/grounds/auction/ceremony/game_light/game_tense.ogg) and the
    estate plays them with crossfades â€” zero code needed from you.
  - Cache: you were right â€” Max plans get the 1h TTL; a 48-min
    self-tick keeps my cache warm and drives the overnight loop.

- **ðŸ•¯ï¸ THE SÃ‰ANCE IS MERGED (the Theater's first social deduction,
  research pitch #1 â€” and it is gorgeous).** Four
  ...
  honest â€” the paid hand IS the difference. Caught = one kill_event for
  ...
  "Â· at the theater Â·" alongside THE UNDERSTUDY (also merged â€” the
  ...
  Sample clue from the SÃ©ance board: "Five letters. The estate's most
  permanent guest room." The Executor, at the verdict: "The word, for
  the record, was GRAVE."
- **âš™ï¸ SETTINGS V2 SHIPPED (menus first-class, per your call).** ESC now
  ...
  How-to-Play cards render whatever is ACTUALLY bound â€” they can't lie.
  ...
  badge agent (shapes â— â–² â–  â—† beside every name in all 9 contract-game
  HUDs). Next: Ready Room press-A-to-join + How-to-Play cards.
- **ðŸ“œ YOUR THREE IDEAS ARE ON THE BOOKS** (docs/design/
  05-director-notes-2026-07-05.md): (1) the host is THE EXECUTOR â€” a
  ...
  Theater â€” stage venue on the grounds for short couch-native social
  ...
  live griefing in chaos) â€” approved direction, sequenced AFTER v3
  lands and you playtest it, so the waves don't collide. Meshy credits
  noted â€” plenty for the butler, the stage, and bigger courses.

- **ðŸ•¯ï¸ NEW CEREMONY: THE READING OF THE WILL.** After the podium, the
  night's superlatives are read like an inheritance â€” THE WORKHORSE (won
  ...
  and the top one is carved into the graffiti wall â€” the estate now tells
  the night's story back. Also fixed on the way: the night used to
  DEAD-END on the winner banner; "DAWN â€” BACK TO THE GATES" now returns
  you to the lobby. Screenshot: `verify_out/will/snap_will_reading_7002.png`.
- **ðŸŽ© COSMETICS ARE MERGED (relaunch to get them).** 8 Meshy hats fitted
  to all four characters â€” viking helm, tophat+monocle, halo, chef hat,
  ...
  post-merge. Look at `docs/verify/shots/cosmetics_combo.png` â€” the
  ...
  at halo 300 â€” "earned innocence") is my next own-hands pass.
- **HANDOFF COMPLETE**: I'm the new director post-compaction; the thread
  ...
  culture unchanged â€” its screenshots get read before any merge.

- **ðŸ° THE ESTATE IS NOW THE MAIN MENU (relaunch again!).** Boot lands on
  ...
  "THE UN-PARTY" is my placeholder â€” rename freely. Coming in later
  passes: Ready-Room press-A-to-join seats, How-to-Play cards + practice
  doors, full ESC settings tabs (research MUST list).
- **âœ… UNBLOCKED â€” CONTINUE YOUR TEN-GAME NIGHT (relaunch first).** All
  three playtest issues fixed & committed: (1) Reckoning continue button
  was pushed off-screen by long tickers â€” panel now grows UPWARD + ticker
  capped at 8 lines; (2) Par back to 1 trap per round per your correction
  (more TYPES coming instead â€” agent building 8 new traps + bigger courses
  + a new large "Gauntlet" course + TRUE simultaneous chaos + OOB
  adventure gutters); (3) ramp-stranded balls now return to their last
  on-green lie ("X WENT EXPLORING â€” RETURNED").
- **Cosmetics: your wishlist is feasible and in flight** â€” rather than
...
- **Menu research is IN** (`docs/design/04-menu-ux-research-digest.md`).
  ...
  tri-state; and one CRITICAL accessibility note â€” our player identity is
  ...
  folded in.
- **ðŸ† THE ROSTER IS COMPLETE: TEN GAMES.** Last Will just merged â€” the
  ...
  last will â€” all in the auction pool, all reviewed.
- **ðŸŽ¯ BOT-MIX IS MERGED â€” GO PLAY.** All eight minigames now honor
...
- **IMPORTANT: fully CLOSE and RELAUNCH the game.** The auction fix is
  ...
  button signals (bid â†’ CHOOSING â†’ click card â†’ launch: PASS). A running
  Godot instance keeps pre-fix scripts â€” your "still broken" was almost
  certainly the stale build.
- **Fixed this pass**: estate leakage (Trail stones/sun/environment were
  visible behind Tilt etc. â€” now fully hidden during minigames); bid
  buttons relabeled "NAME: RAISE TO nâ™ " and disabled for bots.
- **NEW DEVICE in ESC menu: "KB (WASD) + MOUSE"** (LMB=A, RMB=B). Mouse
  ...
  bot-mix retrofit merges â€” the two would collide in the same files.
...
- **YOUR TWO PLAYTEST ISSUES: FIXED (pull/relaunch).** (1) Auction bug
  ...
  registered â€” now single-fire with a proper CHOOSING phase. (2) **ESC now
  ...
  retrofit agent lands (in flight â€” Par gets a full bot too, so you can
...
- **In flight now**: per-player-bot retrofit (all 8 games), THE THRONE
  ...
  seagull, gilded pot, throne, lanterns, gate, podium) â€” I review before
  any integration.
...
- **THE FLEET IS HOME: EIGHT GAMES LIVE.** Par for the Curse (3 courses +
  ...
  Weight â€” all reviewed, merged, and in the Estate auction pool. Start an
  ESTATE NIGHT and the podium picks from all eight. Throne + Last Will
  specs are staged for the next wave (â†’ roster of 10).
- **MORNING REVIEW MENU**: (1) The PILGRIMAGE TRAIL is built and live â€”
  ...
  v1.1 + Tilt v1.1 merged â€” feel-check the parry and the clash when you
...
- **PLAYTESTABLE: ECHO CHAMBER, TILT, and ORBITAL DODGEBALL are merged and
  ...
  auction into either. (Echo needs real-time input â€” gamepads shine;
...
- Still building: Orbital Dodgeball (Fable), Dead Weight (Opus), Par v2
  (Opus â€” your 3+chaos/2x-hazards/3-courses changes).
...
- **Input policy (Alex, 2026-07-04)**: assume one full control surface per
  player (M+KB or gamepad) â€” no shared-surface contortions needed for
  ...
  (later phase â€” Godot high-level multiplayer, likely WebRTC for browser).
- **Animation readability > new mechanics**: Tilt's knockback and Echo's
  attacks existed but didn't READ in tests â€” v1.1 builders are adding real
...
- Research receipts live in `docs/design/02-research-notes.md` (genre) and
  ...
  our accreting-board idea is confirmed unshipped white space â€” closest
  ancestors: Ultimate Chicken Horse, Death Race 1976 gravestones, Legacy
  board games).

## LOG

### 2026-07-05 â€” MESHY PROPS LIVE IN-GAME (wave closed)
...
already in. ALL AGENTS HOME â€” the field is quiet until your notes.

### 2026-07-05 â€” MOUSE AIM MERGED (KB+MOUSE cursor combat live)
...
### 2026-07-05 â€” THE THRONE MERGED (game #9)
...
### 2026-07-05 â€” MESHY CUSTOM PROPS MERGED (10/10 keepers)
...
manor gate, auction podium â€” all chunky-lowpoly on-style, zero retries.
...
re-run). Not yet wired into scenes â€” that's my integration pass, queued
behind your playtest. Key never touched the repo (verified).

### 2026-07-05 (night shift, later) â€” Swap Meet MERGED (game #7)
...
### 2026-07-05 (night shift, later) â€” Greed Inc. MERGED (game #6)
...
### 2026-07-05 (night shift, later) â€” Mower Mayhem MERGED (game #5)
...
### 2026-07-05 (night shift) â€” your bedtime asks, executed
- **5 new minigame specs written** (target roster 10):
  GREED INC. (pot grab-and-run banking), SWAP MEET (kart race where every
  hit swaps positions â€” 1st place is a bullseye), MOWER MAYHEM (Splatoon-
  style lawn coverage in our mow-stripe language), THE THRONE (musical-
  chairs tyranny), LAST WILL (the dead draft blessings/curses â€” kingmaking
...
- **Estate progression designed: THE PILGRIMAGE TRAIL** â€” the leaderboard
  becomes literal terrain: stepping-stones spiral up the hill to the Manor;
  pawns advance by POINTS EARNED (no dice, ever â€” the Pro-Rules lesson);
  ...
  elimination) in the same design doc â€” wants your read before building:
...
- **Tilt v1.1 MERGED**: shove-clash counter with 0.12s windup â€” honest
...
### 2026-07-04 â€” PAR v2 MERGED (your playtest changes are live) + more fleet
- **Par v2** (Opus build, reviewed): 3 rounds + CHAOS round (golden hour,
  ...
  round, and THREE COURSES â€” fairway / dogleg (L-shape, bank-shot corner) /
...
- **Orbital Dodgeball merged** â€” the 45-second ghost-orbit kill works;
...
### 2026-07-04 â€” First two fleet deliveries reviewed & MERGED
- **ECHO CHAMBER** (Opus build): past-rounds-as-ghosts arena brawl. Live
  players textured w/ rings; ghosts flat translucent tints â€” readable even
...
### 2026-07-04 â€” Podium ceremony (core, reusable)
...
podium. Confetti rain, name tags, pastel blocks. `core/podium.gd` â€” built
reusable so minigames can adopt it at merge. Screenshot:
`verify_out/podium2/shot_2900.png`

### 2026-07-04 â€” AAA polish pass, part 1 (your standing directive)
...
- **Kenney UI theme project-wide**: chunky green pill buttons with depth +
  proper panels â€” every button/panel in menu, Par, and Estate upgraded in
...
### 2026-07-04 â€” Estate E2a: the grounds are ALIVE
...
Screenshot: `verify_out/e2/shot_0600.png` â€” Mage at the stall, Rogue on the
path, auction running. Still to come in E2b: stall purchases, seeded walkway
traps, station-proximity interactions.

### 2026-07-04 â€” The Estate E1 built & verified (by Claude directly)
Night loop works end-to-end: Grounds betting â†’ grudge auction â†’ game module
â†’ Reckoning ticker â†’ champion monument. **Cross-session persistence
...
### 2026-07-04 â€” Builder fleet launched (5 agents, isolated worktrees)
- TILT â€” Fable. ORBITAL DODGEBALL â€” Fable. ECHO CHAMBER â€” Opus.
  DEAD WEIGHT â€” Opus. PAR v2 upgrade â€” Opus.
...
### 2026-07-04 â€” Crusher bug fixed (your playtest find)
Root cause: Godot AnimatableBody3D with sync_to_physics ignores ancestor
moves once physics registers it â€” the hammer froze at the ghost's spawn
...
### 2026-07-04 â€” Anthology framework shipped
`core/minigame.gd` (module contract: config in, results out incl.
currency_events â€” royalty/grudge economy is the anthology signature),
`core/player_input.gd` (per-player devices: gamepads > keyboard halves >
shared mouse). Par retrofitted to emit contract results.

### 2026-07-04 â€” Par for the Curse v1 complete (11 commits)
Playable 2â€“4P hotseat sabotage golf: draft/build/putt, killers, gravestones,
royalties, CURSED deck, KayKit caddies (author cheers when their trap
kills), flyover ending. Budget: $0, all CC0.

### 2026-07-05 â€” THE KILLCAM shipped (commit ef23010)
...
colored vignette border + "AUTHOR'S TRAP â€” SIGNED WORK" banner (the sabotage-
authorship flex). Self-kills: "SELF-INFLICTED. THE ESTATE APPLAUDS." (no border,
Executor's register). CHAOS never pauses â€” credit banner only. Skippable (click/
...
- How it's cheap + safe: each ball keeps a per-tick global_transform ring buffer
  (~2.6s); replay is transform playback on a throwaway clone â€” real balls/traps/
...
- Determinism proven both ways: same seed, killcam x2 == --nokillcam, 11/11
  gameplay-receipt lines byte-identical â€” headless AND windowed (with 2 real
