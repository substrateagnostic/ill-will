...
func _run() -> void:
	...
	_gcam(Vector3(-21.0, 2.4, -23.0), Vector3(-30.0, 0.5, -30.0), 50.0)
	await _settle(); await _snap("w3_bone_bridge")
	...
	_gcam(Vector3(23.0, 4.5, -23.0), Vector3(32.0, 0.0, -29.5), 50.0)
	await _settle(); await _snap("w8_garden_court")
	print("G1_SHOTS_DONE")
	get_tree().quit()
